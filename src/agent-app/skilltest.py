...
y = save_to_blob.invoke(
    {
        "container_name": "summaries",
        "blob_name": "summary_of_BEC_attacks.txt",
        "file_content": "Detailed description of Business Email Compromise (BEC) attacks.",
    }
)
print(y)
...
z = send_email.invoke(
    {
        "recipient": "randyt@microsoft.com",
        "subject": f"Test Email - {random_number}",
        "body": "This is a test email from Langchain.",
    }
)
print(z)
...
x = llm_with_tools.invoke(
    "Send an email to randyt@microsoft.com with a random subject and body."
)
print(x)
# pretty print the json result
print(json.dumps(x.to_json(), indent=2))
